...
//settings will go here. For now they will be compiled in.
...
} faentry; //entry struct for the fully associative cache 

// these are our arrays for Direct Mapped
entry L1i[L1_cache_size/L1_block_size];
entry L1d[L1_cache_size/L1_block_size];
entry L2[L2_cache_size/L2_block_size];

//these are our arrays for fully associative
